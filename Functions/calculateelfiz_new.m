...
if any(data.HH.apnum>0)
    ...
    if ~isempty(datasum.steadysweep) %%%%%%%%%%%%%%%%%%%%%%steady state APs
        for i=1:datasum.steadyAPnum
            ...
            datasum.steadythresholddiff = mean((datasum.steadythresholds-data.pass.v0s(datasum.steadysweep)*1000));
...
%             datasum.steadythresholddiff= datasum.steadythresholds(1)-data.pass.v0s(datasum.steadysweep)*1000;
...
if any(data.HH.apnum,2)
    fieldstoremove = {'noiselevel', 'filterednoiselevel', 'sampleinterval','ramp','rheobaseramp', 'bursting', 'steadyahpslowwidth', 'steadyahpslowampl',...
        ...
        'adpampl', 'adpwidth', 'steadyadpampl', 'steadyadpwidth', 'taunoldfail1'};
